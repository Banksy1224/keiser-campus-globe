...
export const CAMPUSES: Campus[] = [
  ...
  },
  {
    ...
    lat: 16.4637,
    lng: 107.5909,
    photo: "campuses/vietnam.jpg",
    tagline: "An American university in Vietnam.",
    description:
      "Based in the historic city of Hue, Keiser University Vietnam extends Keiser's American, English-language model to central Vietnam, giving Vietnamese students international degree programs and direct pathways into the wider Keiser network.",
    established: "Keiser global campus",
