...
export const CAMPUSES: Campus[] = [
  {
    ...
    tagline: "U.S. residential campus with NAIA sports.",
    description:
  ...
  },
  {
    ...
    lat: 26.1224,
    lng: -80.1373,
    tagline: "The main and original campus.",
    description:
      "The main and original Keiser campus, founded in 1977, sits minutes from downtown Fort Lauderdale. It remains a flagship hub for health science and nursing students who want a clinical, career-focused start in the heart of South Florida.",
    established: "1977",
  ...
  },
  {
    ...
    lat: 26.0078,
    lng: -80.2963,
    tagline: "The Campus of Advanced Technology.",
    description:
      "Keiser's Campus of Advanced Technology in southern Broward County, where students train on industry-grade equipment across technology, engineering, and health-science programs — built for hands-on, career-ready learning.",
    established: "Broward County campus",
    setting: "Campus of Advanced Technology",
    programs: ["Information Technology", "Engineering Technology", "Nursing (BSN)", "Biomedical Sciences"],
    highlights: [
      "Industry-grade technology & labs",
  ...
  },
  {
    ...
    lat: 26.1929,
    lng: -80.17,
    tagline: "Award-winning grad programs in English, Spanish & Mandarin.",
    description:
      "Keiser University's Graduate School delivers award-winning online and on-ground graduate programs offered in English, Spanish, and Mandarin — across business, education, psychology, and the health sciences — built for working professionals.",
    ...
    highlights: [
      "Award-winning online & on-ground graduate programs",
      "Offered in English, Spanish & Mandarin",
      "Built for working professionals",
    ],
  ...
  },
  {
    ...
    lat: 26.1955,
    lng: -80.173,
    tagline: "Award-winning online undergrad in English, Spanish & Mandarin.",
    description:
      "Keiser's eCampus delivers award-winning online undergraduate programs in Spanish, English, and Mandarin, supported from the Nineteen Hundred Building in Fort Lauderdale. It's built for working adults, military students, and learners worldwide who want the Keiser experience without relocating.",
    ...
    highlights: [
      "Award-winning online undergraduate programs",
      "Offered in English, Spanish & Mandarin",
