...
- Click a numbered building on the map, a legend row on the artwork, or a campus in the left rail to fly there. The selected campus **pulses** (building + yellow badge). Miami (#19) pulses all three southern badges. Flagship (#6) and West Palm Beach (#17) stay separate.
